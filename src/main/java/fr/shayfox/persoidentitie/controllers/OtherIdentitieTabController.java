...
public class OtherIdentitieTabController implements Initializable {
    ...
    public JFXTextField NameLabel, PrenameLabel, GenreLabel, MarriedNameLabel, BornDateLabel, DeathDateLabel, BornCityLabel, DeathCityLabel,
            ...
            AscendingLabel, ChineseSignLabel, DecanLabel, AnimalTotemLabel, PlanetLabel, MainResidencePlaceLabel, Owner;
    ...
    @FXML
    public JFXButton button_Galerie;
    ...
    public void initData(String FileProfile, StackPane stackPane) {
        root = stackPane;
        ...
        Owner.setText(filename.split("\\)")[0].replace("(", ""));
